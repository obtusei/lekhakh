...
export function LogoLink({ width }: { width?: string }) {
  ...
  return (
    <Link href={"/"}>
      <Logo
        width={width}
        p={colorScheme === "dark" ? "#F7B500" : "#CE0009"}
        s={colorScheme === "dark" ? "#ffffff" : "#000000"}
      />
    </Link>
  );
}
...
export function LikeButton({
  ...
  return (
    ...
    >
      {doesLike ? (
        <HeartIconFilled color="red" />
      ) : (
        <HeartIcon color={colorScheme === "dark" ? "white" : "black"} />
      )}
    </ActionIcon>
  );
}
...
export function BookmarkButton({
  ...
  return (
    ...
    >
      {doesSave ? (
        <BookmarkFilledIcon color="green" />
      ) : (
        <BookmarkIcon color={colorScheme === "dark" ? "white" : "black"} />
      )}
    </ActionIcon>
  );
}
