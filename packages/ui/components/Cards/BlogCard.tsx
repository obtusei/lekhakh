  ...
  return (
    <div>
      ...
      <Link href={`/blog/${props.id}`} key={props.id}>
        <Stack
          style={{ flexDirection: "row", padding: "0px", minWidth: "400px" }}
        >
          {isSmall && <Title style={{ opacity: 0.4 }}>{index}</Title>}
          <Card
            shadow="sm"
            p="md"
            radius="md"
          ...
          >
                ...
                <Avatar
                  ...
                  src={
                    props?.user.image != null
                      ? `http://localhost:3002${props.user.image}`
                      : ""
                  }
                  radius={20}
                >
            ...
            {!isSmall && (
              <>
                <Text lineClamp={4} color="dimmed">
                  {convert(props.content, { wordwrap: 130 })}
                </Text>
                <Group mt={"sm"}>
                  {props?.tag != null &&
            ...
            <Group position="apart" mt={"md"}>
              <Group>
                ...
                />
                <CommentButton
                  onClick={() => router.push(`/blog/${props.id}?comment=true`)}
                />
                {/* <ShareButton/> */}
              </Group>
              <BookmarkButton
